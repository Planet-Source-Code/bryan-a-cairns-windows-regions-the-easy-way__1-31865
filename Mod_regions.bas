...
Public Function AddRGNPoly(AllAreas As Areas, P() As POINTAPI, nCount As Long, sName As String, NormalColor As Long, AlertColor As Long, RGNhatch As RGNHatchType, RGNBrush As RGNBrushType) As Boolean
On Error GoTo EH
Dim ANumber As Long
Dim Apen As Long
Dim ABrush As Long 'normal brush
...
AllAreas.Add ANumber, ABrush, AABrush, Apen, sName, NormalColor, AlertColor, False, 0, "", CLng(RGNhatch), "Polygon"
AddRGNPoly = True
Exit Function
EH:
AddRGNPoly = False
